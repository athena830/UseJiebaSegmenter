<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="FB_List.aspx.cs" Inherits="UseJiebaSegmenter.FB_List" %>
            ...
            <ItemTemplate>
                <tr>
                    ...
                    <td class="text-center">
                        <a href='FB_Detail.aspx?score=<%# Eval("score") %>' class="btn btn-primary">列表</a>
